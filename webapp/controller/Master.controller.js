		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "corp.basf.ProjectBasf.view.ViewSettingsDialog",
					controller: this
